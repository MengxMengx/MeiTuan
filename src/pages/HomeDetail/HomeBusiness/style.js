...
export const Wrapper = styled.div`
  ...
  .seller .seller-wrapper .seller-view .address-wrapper .address-left {
    flex: 1;
    // background: url('../assets/images/seller/address.png') no-repeat left center;
    padding-left: 1.2rem;
  ...
  .seller .seller-wrapper .seller-view .address-wrapper .address-right {
    flex: 0 0 60px;
    // background: url('../assets/images/seller/line.png') no-repeat left center;
  ...
  .seller .seller-wrapper .seller-view .address-wrapper .address-right .content {
    width: 100%;
    height: 100%;
    // background: url('../assets/images/seller/phone.png') no-repeat center center;
  ...
  .seller .seller-wrapper .seller-view .safety-wrapper {
    ...
    // background: url('../assets/images/seller/safety.png') no-repeat left center;
    background-size: 0.636rem 0.727rem;
    font-size: 0.636rem;
  }
  ...
  .seller .seller-wrapper .tip-wrapper .delivery-wrapper {
    // background: url('../assets/images/seller/delivery.png') no-repeat left center;
    background-size: 0.636rem 0.727rem;
  ...
  .seller .seller-wrapper .tip-wrapper .shipping-wrapper {
    // background: url('../assets/images/seller/time.png') no-repeat left center;
  ...
  .seller .seller-wrapper .other-wrapper .server-wrapper {
    // background: url('../assets/images/seller/server.png') no-repeat left center;
    background-size: 0.681rem 0.681rem;
